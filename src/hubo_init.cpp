...
RVizSensorControlPanel::RVizSensorControlPanel(QWidget *parent)
    : rviz::Panel(parent)
{
    content = new RVizSensorControlPanelWidget;
    QHBoxLayout* panelLayout = new QHBoxLayout;
    panelLayout->addWidget(content);
    setLayout(panelLayout);
}

RVizSensorControlPanelWidget::~RVizSensorControlPanelWidget()
{
...
RVizSensorControlPanelWidget::RVizSensorControlPanelWidget(QWidget *parent)
    : QTabWidget(parent)
{
...
void RVizSensorControlPanelWidget::initializeIMUStateTab()
{
...
void RVizSensorControlPanelWidget::initializeFleaStateTab()
{
	//Create a grid layout.
...
void RVizSensorControlPanelWidget::initializeHokuyoStateTab()
{
	//Create a box layout.
...
void RVizSensorControlPanel::save(rviz::Config config) const
{
...
void RVizSensorControlPanel::load(const rviz::Config &config)
{
...
} // End rviz_sensor_control_panel_space




#include <pluginlib/class_list_macros.h>
PLUGINLIB_EXPORT_CLASS( rviz_sensor_control_panel_space::RVizSensorControlPanel, rviz::Panel )
PLUGINLIB_EXPORT_CLASS( rviz_sensor_control_panel_space::RVizSensorControlPanelWidget, QTabWidget )
